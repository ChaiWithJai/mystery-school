# Historical README checkpoint

Archived from `cc443a7` before the documentation restructure. These instructions and results are historical; use the [current README](../README.md) and [documentation index](README.md). Relative links in this snapshot originally resolved from the repository root.
