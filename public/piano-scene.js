...
export function mountPianoScene(container,adapter,track,onContinue){
  ...
  scene.innerHTML=`<div class="piano-scene__light" aria-hidden="true"></div><div class="piano-scene__invitation"><span>RUNAWAY</span><p>Listen. Find the first sound.</p><button class="piano-scene__listen" aria-label="Inspect the Runaway reference">↗ Artist reference</button></div><svg viewBox="0 0 1100 330" class="piano-scene__notes" role="img" aria-label="Your played notes, shown as light"><g data-take-lines></g><g data-held-lights></g></svg><div class="piano-scene__reference" hidden><button data-close-reference aria-label="Close song reference">×</button><div data-player></div><a href="https://www.youtube.com/watch?v=Bm5iA4Zupek" target="_blank" rel="noopener">Open the official video ↗</a></div>`;
  piano.prepend(scene);
  ...
  referenceButton.onclick=()=>{reference.hidden=false;scene.querySelector('[data-player]').textContent='The exercise plays here. The original artist video opens separately.';track('reference.open',{url:'https://www.youtube.com/watch?v=Bm5iA4Zupek',source_kind:'artist_video',automatic_transcription:false});};
